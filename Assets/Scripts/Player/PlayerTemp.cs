...
public class Player : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        mAnimator.speed = 1 + (float)(mStats.Spd / 50.0f);
    ...
    private bool ActionHandler()
    {
        ...
        else
        {
            ...
            else if (Input.GetKeyDown("z") && mRunning)//TODO: Add NEED run for x frames to get slide
            {
                Slide();
                return true;
            }
    ...
    {
        //Change side
        if (Input.GetKeyDown(KeyCode.Space) && Mathf.Approximately(mRigidBody.velocity.magnitude, 0.0f))
        {
            mGroundY = transform.position.y;
            Jump();
        }
    ...
    void FixedUpdate()
    {
        ...
        else if (Input.GetKeyDown("q"))//Saturday
        {
            Dash();
        }/*
        ...
        print(mRigidBody.velocity.magnitude);
        UpdateAnimator();
    }
